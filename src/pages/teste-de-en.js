                ...
                <section class="description-section py-5">
                    <div class="container">
                        <div class="row shadow-sm py-5">
                            ...
                            <div class="col-md">
                                <h2 class="description-title">Teste de proficiência em inglês</h2>
                                <p class="description-text">Teste seu nível de inglês hoje! Nosso teste de inglês online lhe dará resultados que você pode usar para comparar sua habilidade actual e começar a planejar sua jornada de aprendizado.
                                    Nosso teste de inglês avaliará sua habilidade linguística em vários critérios-chave e calculará seu nível de inglês.</p>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Por que fazer um teste de nível de inglês?
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="acordian-list">
                                            <li class="mb-2">Para encontrar o curso mais adequado para sua habilidade actual, você precisa saber qual é o seu nível de proficiência actual. Ao fazer o teste de inglês, você será notificado sobre seu nível de idioma.</li>
                                            <li class="mb-2">O teste de inglês online irá combiná-lo com precisão com os cursos mais apropriados para sua habilidade actual.</li>
                                            <li class="mb-2">Você pode usar suas classificações de teste de inglês para compartilhar com empregadores e instituições acadêmicas para que eles entendam sua capacidade de falar inglês.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        O que acontece depois de concluir o teste de nivelamento de inglês?
                                    </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                    data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Depois de concluir o teste de nivelamento de inglês , você receberá um relatório detalhado sobre seu nível actual de proficiência. Com base nesse relatório, será possível recomendar o curso e os materiais mais adequados para o seu nível, ajudando você a alcançar seus objectivos de aprendizado.
                                    </div>
                                </div>
                            </div>
                        </div>
